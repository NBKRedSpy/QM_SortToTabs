...
Due to Steam's Workshop description character limit, the change log can be found [url=https://github.com/NBKRedSpy/QM_SortToTabs/blob/master/CHANGELOG.md]here[/url]
